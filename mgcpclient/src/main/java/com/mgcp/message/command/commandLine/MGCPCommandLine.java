...
public class MGCPCommandLine {
	...
	public MGCPCommandLine(MGCPVerb mgcpVerb, int transactionId, EndpointName endpointName) {
		this(mgcpVerb, transactionId, endpointName, Constants.MGCPversion);
	}

	public MGCPCommandLine(MGCPVerb mgcpVerb, int transactionId, EndpointName endpointName, String mgcpVersion) {
	...
	public MGCPCommandLine(String extensionVerb, int transactionId, EndpointName endpointName) {
		this(extensionVerb, transactionId, endpointName, Constants.MGCPversion);
	}

	public MGCPCommandLine(String extensionVerb, int transactionId, EndpointName endpointName, String mgcpVersion) {
