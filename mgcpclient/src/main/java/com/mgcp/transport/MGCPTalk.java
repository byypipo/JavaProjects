...
public class MGCPTalk {
	...
	public boolean isCompleted() {
		if (NullUtil.isNull(mgcpCommand)) {
			return false;
		}

		if (NullUtil.isNull(mgcpResponse)) {
			return false;
		}
	...
	public String toString() {
		...
		if (NullUtil.isNotNull(mgcpCommand)) {
			builder.append(Constants.mgcpCommandLogHeader + "\n" + mgcpCommand.toString() + Constants.mgcpMessageLogFooter + "\n");
		}

		if (NullUtil.isNotNull(mgcpCommand)) {
			builder.append(Constants.mgcpResponseLogHeader + "\n" + mgcpResponse.toString() + Constants.mgcpMessageLogFooter + "\n");
		}
