...
public class GcmPushInfo {
	...
	public GcmPushInfo(List<String> regIdList, String data, Notification notification) {
		setData(data);
		setNotification(notification);
		setRegIdList(regIdList);
	}

	public GcmPushInfo(String regId, String data, Notification notification) {
		setData(data);
		setNotification(notification);
	 ...
	 * key-value pairs of the message's payload data.
	 * 
	...
	/**
	 * This parameter specifies a JSON object whose fields represents the
	 * key-value pairs of the message's payload notification.
	 * 
	 * @see https://developer.android.com/google/gcm/server.html#send-msg
	 */
	...
	/**
	 * This parameter specifies a string array containing the list of devices
	 * (registration IDs) receiving the message.<br />
	 * It must contain at least 1 and at most 1000 registration IDs. To send a
	 * multicast message, you must use JSON.
	 * 
	 * @see https://developer.android.com/google/gcm/server.html#send-msg
	 */
	 ...
	 * if the device is idle. Default value is as false for low latency.
	 * 
	 * @see https://developer.android.com/google/gcm/server.html#send-msg
	 */
	...
	/**
	 * TTL for the push in case of offline devices. Default value is as false
	 * for low latency.
	 * 
	 * @see https://developer.android.com/google/gcm/server.html#send-msg
	 */
